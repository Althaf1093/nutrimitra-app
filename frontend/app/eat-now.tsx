  ...
  return (
    <View style={[styles.root, { paddingTop: insets.top }]} testID="eat-now-screen">
      <View style={styles.appHeader}>
        ...
        <Pressable testID="eat-now-close" accessibilityLabel={t.close} onPress={() => router.back()} style={styles.iconButton}>
      ...
      {!data && !error ? (
        ...
        <View style={[styles.center, { padding: 24 }]}>
          <Text style={styles.errorText} testID="eat-now-error">{error}</Text>
        ...
        <>
          <ScrollView contentContainerStyle={styles.screenContent} showsVerticalScrollIndicator={false}>
            ...
            <Text style={styles.modalMeal} testID="eat-now-meal-name">{data.suggestion.name}</Text>
